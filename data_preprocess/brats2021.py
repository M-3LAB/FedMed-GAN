...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_path", default="/disk4/xgy/medical/BraTS2021/training", nargs='+', type=str, help="path to train data")
    parser.add_argument("--test_path", default="/disk4/xgy/medical/BraTS2021/validation", nargs='+', type=str, help="path to test data") 
    parser.add_argument("--root_generated_path", default="/disk4/xgy/medical/brats2021", nargs='+', type=str, help="path to target root")
    parser.add_argument("--train_generated_path", default="/disk4/xgy/medical/brats2021/training", nargs='+', type=str, help="path to target train data")
    parser.add_argument("--test_generated_path", default="/disk4/xgy/medical/brats2021/validation", nargs='+', type=str, help="path to target test data") 
