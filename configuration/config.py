...
def parse_arguments_kaid():
    ...
    #parser.add_argument('--src-msl', type=str, help='source domain mask side length')
    #parser.add_argument('--tag-msl', type=str, help='target domain mask side length')
    parser.add_argument('--msl-path', type=str, help='mask side length storage path')
