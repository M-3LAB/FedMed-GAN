...
class IXI(BASE_DATASET):
    def __init__(self, root, modalities=["t1", "t2"], learn_mode="train", extract_slice=[29, 100], noise_type='normal',
                 ...
                 moda_ratio=0.5, moda_case='case1', dataset_splited=True, assigned_data=False, assigned_images=None):
        ...
        super(IXI, self).__init__(root, modalities=modalities, learn_mode=learn_mode, extract_slice=extract_slice, noise_type=noise_type,
                                  data_mode=data_mode, data_num=data_num, data_paired_weight=data_paired_weight, transform_data=transform_data,
                                  client_weights=client_weights, dataset_splited=dataset_splited, data_moda_ratio=moda_ratio, data_moda_case=moda_case)
